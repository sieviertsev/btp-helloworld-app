		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello World App Title SM",
									"targetURL": "#sapbtphelloworldui5sm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtphelloworldui5sm-display": {
								"semanticObject": "sapbtphelloworldui5sm",
								"action": "display",
								"description": "A Fiori Hello World application SM",
								"title": "Hello World App Title SM",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.helloworldui5sm",
									"url": sap.ui.require.toUrl("sap/btp/helloworldui5sm")
								}
							}
						}
					}
